...
function Header({ pages = [], settings = [] }) {
            ...
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        ...
                        <Menu sx={{ mt: "45px", minWidth: 100 }} id="menu-appbar" anchorEl={anchorElUser} 
                            ...
                            {settings.map((setting) => (
                                <MenuItem key={setting} onClick={handleCloseUserMenu} sx={{ minWidth: "150px"}}>
                                    <Typography textAlign="end" sx={{ width: "100%" }}>{setting}</Typography>
                                </MenuItem>
                            ))}
                            <MenuItem onClick={handleLogout} sx={{ minWidth: "150px"}}>
                                    <Typography textAlign="end" sx={{ width: "100%" }}>Logout</Typography>
                            </MenuItem>
                        </Menu>
                    </Box>
                </Toolbar>
