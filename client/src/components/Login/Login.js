            ...
            <Container component="main" maxWidth="sm">
                ...
                <Box sx={{ marginTop: 8, marginBottom: 8, display: "flex", flexDirection: "column", alignItems: "center" }}>
                    ...
                    <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
                        <TextField value={identifier} onChange={event => setIdentifier(event.target.value)} 
                            onKeyUp={event => validateIdentifier(event.target.value)}
                            onBlur={event => validateIdentifier(event.target.value)}
                            error={identifierValidate.error} helperText={identifierValidate.helperText}
                            margin="normal" required fullWidth id="identifier" label="Email or Username" 
                            name="identifier" autoComplete="email" />
